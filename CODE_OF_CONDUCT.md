# Code of Conduct for OpenBayanMesh-Edge
...
If you are a victim of or witness to unacceptable behavior, or have any other concerns, please report it as soon as possible. You can report by:

*   **Emailing the project maintainers:** [maintainers@openbayanmesh.org](mailto:maintainers@openbayanmesh.org) (replace with actual email)
*   **Direct message to a specific maintainer:** (e.g., via GitHub or other communication channels if available)
